// dc pin set the lcd to receive commands or data
#define LCD_COMMAND 0
#define LCD_DATA    1

// our nokia display screen size
#define LCD_X       84
#define LCD_Y       48
...
void LcdWrite(byte data_or_command, byte data)
{
  ...
  shiftOut(LCD_DIN, LCD_CLK, MSBFIRST, data); //transmit serial data
...
void LcdDrawStatusBar(boolean music_playing){
  //todo
  //get hour from serial, draw a black bar with the hour in the center
  //if music_playing == true , draw a music simplete at the beggining of the bar
  
}

void LcdInit(void){
 //setting the lcd pins as outputs
  ...
  LcdWrite(LCD_COMMAND,0x14); // LCD bias mode 1:40
  LcdWrite(LCD_COMMAND,0x20); // Must send this before modifying the display control mode
